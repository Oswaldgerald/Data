...
Route:: get('/totalSettlement', [TransactionController::class, 'show_totalSettlement']);

Auth::routes();

Route:: get('/bcxNotBr', [TransactionController::class, 'show_bcxNotBr']);

Auth::routes();

Route:: get('/brNotBcx', [TransactionController::class, 'show_brNotBcx']);
